...
If you've used Realtime prior to the introduction of Broadcast and Presence, you've actually been using this feature all along. Broadcast is the delivery mechanism that sends Postgres changes to your clients. Now, you can send messages directly from client to other clients in a channel without having to persist them in the database.
